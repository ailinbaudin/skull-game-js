    ...
    <div class="bg-surface-0 dark:bg-surface-900">
        <div id="home" class="landing-wrapper overflow-hidden">
            ...
            <div id="hero" class="flex flex-col pt-6 px-6 lg:px-20 overflow-hidden"
                style="background: linear-gradient(0deg, rgba(0, 0, 0, 0.7), rgba(50, 50, 50, 0.9)), radial-gradient(77.36% 256.97% at 77.36% 57.52%, rgb(50, 50, 50) 0%, rgb(0, 0, 0) 100%); clip-path: ellipse(150% 87% at 93% 13%)">
                <div class="mx-6 md:mx-20 mt-0 md:mt-6">
                    <h1 class="text-6xl font-bold text-gray-100 leading-tight"><span class="font-light block">Juego
                            Online</span>Carreras y Calaveras</h1>
                    <p class="font-normal text-2xl leading-normal md:mt-4 text-gray-300">
                        Homenaje a 'Skull Rider', recreando su esencia con un esqueleto intrépido y carreras llenas de
                        desafíos. <br>
                        Mi objetivo fue revivir la experiencia del clásico adaptada a las tecnologías actuales,
                        manteniendo viva su magia. 🏍️💀
                    </p>
                    <Button label="¡Que comience el juego!" as="router-link" to="/game" rounded
                        class="!text-xl mt-8 !px-4"></Button>
                </div>
                <div class="flex justify-center md:justify-end">
                    <img src="/demo/images/landing/rider3.png" alt="Hero Image" class="w-9/12 md:w-auto" />
                </div>
            </div>

            <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
                <div class="text-center">
                    <div class="text-surface-900 dark:text-surface-0 font-normal mb-2 text-4xl">Descubrí
                    </div>
                    <span class="text-muted-color text-2xl">Más sobre el proyecto...</span>
                </div>

                <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
                    <div class="flex justify-center col-span-12 lg:col-span-6 p-0 order-1 lg:order-none"
                        style="border-radius: 8px; background: linear-gradient(to bottom, rgba(0, 0, 0, 0.9), rgba(50, 50, 50, 0.8));">
                        <div class="flex justify-center md:justify-end">
                            <img src="/demo/images/landing/rider.png" alt="Hero Image" class="w-9/12 md:w-auto" />
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">Tecnologías
                            utilizadas:
                        </div>
                        <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal ml-0 md:ml-2"
                            style="max-width: 650px">
                            Este juego ha sido desarrollado con Vue.js para la interfaz, JavaScript para la lógica,
                            PrimeVue para los componentes estilizados y TailwindCSS para un diseño moderno y responsivo.
                            El motor del juego utiliza JavaScript nativo para manejar dinámicas, físicas y colisiones,
                            optimizado con Vite para garantizar un rendimiento fluido.
                        </span>
                ...
                <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
                    <div
                        ...
                        <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">Desarrollado
                            por Ailin Baudin</div>
                        <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal mr-0 md:mr-2"
                            style="max-width: 650px">Soy Desarrolladora Frontend con experiencia en Vue.js, React, y
                            desarrollo de aplicaciones móviles con Ionic y Node.js. Me apasiona crear interfaces
                            modernas, eficientes y centradas en la experiencia del usuario. Manejo herramientas como
                            PrimeVue y TailwindCSS para diseñar soluciones escalables y funcionales.

                            Con una Tecnicatura en Programación y certificaciones en Vue.js Avanzado y Scrum, combino
                            habilidades técnicas y metodológicas para entregar proyectos de alta calidad. Además,
                            disfruto del diseño UX, testing y la colaboración con equipos para superar desafíos y
                            construir productos innovadores.

                            Encuéntrame:
                            LinkedIn | GitHub</span>
                    </div>
